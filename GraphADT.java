...
public interface GraphADT {
   ...
   *
   * If user is null or already exists, method ends without adding a user or throwing an exception.
   * 
   * Valid argument conditions: 1. user is non-null 2. user is not already in the graph
   * 
   ...
   * 
   * If user is null or does not exist, method ends without removing a user, edges, or throwing an
   * exception.
   * 
   * Valid argument conditions: 1. user is non-null 2. user is not already in the graph
   * 
  ...
  /**
   * Add the edge from user1 to user2 to this graph. (edge is directed and unweighted)
   * 
   * If either user does not exist, user IS ADDED and then edge is created. No exception is thrown.
   *
   * If the edge exists in the graph, no edge is added and no exception is thrown.
   * 
   * Valid argument conditions: 1. neither user is null 2. both vertices are in the graph 3. the
  ...
  /**
   * Remove the edge from user1 to user2 from this graph. (edge is directed and unweighted) If
   * either user does not exist, or if an edge from user1 to user2 does not exist, no edge is
   * removed and no exception is thrown.
   * 
   * Valid argument conditions: 1. neither user is null 2. both vertices are in the graph 3. the
   * edge from user1 to user2 is in the graph
   * 
